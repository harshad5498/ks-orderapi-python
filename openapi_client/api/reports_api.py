...
class ReportsApi(object):
    ...
    def get_order_report_by_order_id_with_http_info(self, orderId, consumerKey, sessionToken, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(list[Orders], status_code(int), headers(HTTPHeaderDict))
        """
        ...
        return self.api_client.call_api(
            ...
            response_type='list[Orders]',  # noqa: E501
    ...
    def get_trade_report_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(list[Trades], status_code(int), headers(HTTPHeaderDict))
        """
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[Trades]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
